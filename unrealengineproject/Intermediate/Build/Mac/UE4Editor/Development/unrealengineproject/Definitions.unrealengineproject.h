...
#define ORIGINAL_FILE_NAME "UE4Editor-unrealengineproject.dylib"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME unrealengineproject
#define DEPRECATED_FORGAME DEPRECATED
#define UNREALENGINEPROJECT_API DLLEXPORT
